...
window.addEventListener("load", function () {
  if (document.getElementById('insertMail')) {
    let name = "oxtobymusic" ; // Update yours informations here
    ...
    newAhref.innerHTML = name + ' at ' + domain;
      ...
      // Phone
        $('#telephone').on('blur input', function () {
            ...
            if (!telEntry.match(regexTelephone)) {
                $('#helpTel').text('Invalid phone number').hide().show();
            } else {
                $('#helpTel').slideUp(400);
            }
        })
    ...
    // Email
        $('#mail').on('blur input', function () {
          ...
          if (!mailEntry.match(regexMail)) {
            $('#helpMail').text('Invalid email address').hide().show();
          } else {
...
$(function () {
  let regexMail = /^([a-z0-9_-]+\.)*[a-z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)*\.[a-z]{2,6}$/;
    $('#emailNews').on('blur input', function(event) {
        ...
        if (!mailEntry.match(regexMail)) {
          $('#helpMailNews').text('Invalid email address').hide().show();
          $('#hideNews').hide();
        } else {
...
// Locations
$(function () {
    $(".card").on('click', () => {window.location.href = "https://www.instagram.com/oxtobymusic"});
})
// Location socials
$(function () {
    $('.facebook').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://facebook.com/oxtoby";
    });
    $('.instagram').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://www.instagram.com/oxtobymusic";
    });
    $('.youtube').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://youtube.com/@Oxtoby";
    });
})
